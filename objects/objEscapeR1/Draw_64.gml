...
if (pause == true) {
    ...
    fadeAlpha += fadeSpeed;
    fadeAlpha = clamp(fadeAlpha, 0.1, 0.5);  // Clamp fadeAlpha between 0 (invisible) and 1 (fully visible)
    ...
    fadeAlpha -= fadeSpeed;
    fadeAlpha = clamp(fadeAlpha, 0.5, 0);  // Ensure fadeAlpha stays between 0 and 1
